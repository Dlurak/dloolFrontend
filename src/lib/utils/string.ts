 ...
 */
export const hasLowercaseLetter = (input: string): boolean => /[a-z]/.test(input);
 ...
 */
export const hasUppercaseLetter = (input: string): boolean => /[A-Z]/.test(input);
...
export const hasSpecialCharacter = (input: string, chars = specialCharacters): boolean => {
